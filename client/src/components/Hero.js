  ...
  return (
    ...
    <Container >
      <Row className={styles.row}>
        <Col md={6}>
          <h2>Behind the Bars: Life in Indian Prisons</h2>
    ...
    <Container>
      <Row className={styles.row}>
        ...
        <Col md={6}>
          <h2>Embracing Freedom: A New Chapter Begins</h2>
    ...
    <Container>
      <Row className={styles.row}>
        <Col md={6}>
          <h2>Navigating Challenges: Seeking Solution</h2>
    ...
    <Container>
      <Row className={styles.row}>
        ...
        <Col md={6}>
          <h2>Discovering Kunji: Hope on the Horizon</h2>
    ...
    <Container>
      <Row className={styles.row}>
        <Col md={6}>
          <h2>Reaching Out: A Call for Help and Guidance</h2>
    ...
    <Container>
      <Row className={styles.row}>
        ...
        <Col md={6}>
          <h2>Opening Up: Sharing Struggles with Kunji</h2>
    ...
    <Container>
      <Row className={styles.row}>
        <Col md={6}>
          <h2>Compassionate Guidance: Anvish Lends a Hand</h2>
          <p>Anvish, our dedicated receptionist, helps the ex-prisoner navigate their situation, connecting them with the appropriate resources and support.</p>
        </Col>
        <Col md={6}>
    ...
    <Container>
      <Row className={styles.row}>
        ...
        <Col md={6}>
          <h2>A New Lease on Life: Finding the Help They Need</h2>
